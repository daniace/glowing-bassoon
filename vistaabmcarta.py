...
from ABMSprueba.formularioarquero import FormularioArquero
from ABMSprueba.formulariocarta import FormularioCarta
...
class VistaABMCartas(ctk.CTkToplevel):
    def __init__(self):
        # Ventana principal
        self.root = ctk.CTk()
        self.root.title("Gestión de Cartas")
        self.centrar_ventana()

        # Título
        self.label_titulo = ctk.CTkLabel(
            self.root, text="Gestión de Cartas", font=("Arial", 20)
        )
        ...
        self.tabla.column("Nacionalidad", width=100)
        self.tabla.column("Club", width=100)
        self.tabla.column("General", width=60)
        self.tabla.column("Posición", width=100)
        self.tabla.column("Pace", width=50)
        self.tabla.column("Shooting", width=50)
        self.tabla.column("Passing", width=50)
        self.tabla.column("Dribbling", width=50)
        self.tabla.column("Defending", width=50)
        self.tabla.column("Physic", width=50)
        self.tabla.column("GK Diving", width=50)
        self.tabla.column("GK Handling", width=50)
        self.tabla.column("GK Kicking", width=50)
        self.tabla.column("GK Reflexes", width=50)
        self.tabla.column("GK Speed", width=50)
        self.tabla.column("GK Positioning", width=50)
