...
from ABMSprueba.formularioesquipo import FormularioEquipo
...
class VistaABMEquipo(ctk.CTkToplevel):
    def __init__(self):
        ...
        self.label_titulo = ctk.CTkLabel(
            self.root, text="Gestión de Equipos", font=("Arial", 20)
        )
        ...
        self.tabla.column("ID_Equipo", width=50)
        self.tabla.column("ID_Usuario", width=50)
        self.tabla.column("Nombre_Equipo", width=100)
        self.tabla.column("Carta 1", width=50)
        self.tabla.column("Carta 2", width=50)
        self.tabla.column("Carta 3", width=50)
        self.tabla.column("Carta 4", width=50)
        self.tabla.column("Carta 5", width=50)
        self.tabla.column("Carta 6", width=50)
        self.tabla.column("Carta 7", width=50)
        self.tabla.column("Carta 8", width=50)
        self.tabla.column("Carta 9", width=50)
        self.tabla.column("Carta 10", width=50)
        self.tabla.column("Carta 11", width=50)
