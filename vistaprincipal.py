...
from ABMSprueba.controladorabmusuario import ControladorABMUsuarios
from ABMSprueba.controladoradmcarta import ControladorABMCartas
from ABMSprueba.controladorequipo import ControladorABMEquipo
...
class VistaPrincipal(ctk.CTk):
    def __init__(self):
        ...
        # self.controlador_abm_usuarios = ControladorABMUsuarios()
        # self.controlador_abm_carta = ControladorABMCartas()
        # self.controlador_abm_equipo = ControladorABMEquipo()
